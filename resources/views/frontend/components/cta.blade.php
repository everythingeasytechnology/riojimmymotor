        ...
        <div class="cta-banner text-white">
            <div class="row align-items-center position-relative" style="z-index: 2;">
                ...
                <div class="col-lg-8 mb-4 mb-lg-0 text-center text-lg-start">
                    <h3 class="text-white mb-2 fw-700">Looking for a Specific Part or Need Expert Help?</h3>
                    <p class="text-white-50 m-0 lead" style="font-size: 16px;">We have direct connection with over 200+ certified salvage yards nationwide. Let our team locate your auto part within minutes - completely free of charge.</p>
                </div>
